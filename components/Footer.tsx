        ...
        <div className="mt-6 ml-4 sm:ml-10 md:ml-0">
            <div className="flex flex-wrap items-end gap-x-10 gap-y-6 ">
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  <svg className="shrink-0 transition-opacity" width="30" height="30" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path d="M20 4H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2zm0 2-8 5-8-5h16zm0 12H4V8.236l8 5 8-5V18z"/>
                  </svg>
                  cindynakh@gmail.com
                  <span className="absolute left-0 -bottom-3 h-[10px] w-0 bg-white transition-all duration-300 ease-out group-hover:w-full" />
                </a>
                <button
                  onClick={copyEmail}
                ...
                >
                  <Image src="/copy.svg" alt="Copy email" width={24} height={24} className="invert" />
                </button>
              </div>

              {/* Social icon buttons */}
              <div className="flex items-center gap-4 pb-[2px]">
                <a href="https://github.com/cnakha" target="_blank" rel="noopener noreferrer"
                  aria-label="GitHub"
                ...
                <a href="https://www.instagram.com/cindynakh_design" target="_blank" rel="noopener noreferrer"
                ...
                <a href="https://www.linkedin.com/in/cindy-nakhammouane-348a63247/" target="_blank" rel="noopener noreferrer"
                  aria-label="LinkedIn"
                  className="transition hover:scale-110 active:scale-95">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
