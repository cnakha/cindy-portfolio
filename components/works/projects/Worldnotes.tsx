...
export default function Worldnotes() {
  ...
  return (
    <div className="flex flex-col mt-8 text-black">
      ...
      />
      <div className="mt-10"/>
      <Picture type={"half"} useAspectRatio popup={true} source={"/projects/worldnotes/post_viewer2.png"} source2={"/projects/worldnotes/post_viewer3.png"}/>
      <div className="mt-20 sm:mt-10"/>
      ...
      />
      <div className="mt-10"/>
      <Picture type={"half"} useAspectRatio popup={true} source={"/projects/worldnotes/note_details.png"} source2={"/projects/worldnotes/location_picker.png"}/>

      <div className="mt-30"/>
      <div className="relative flex flex-col">
          <h2 className="text-display">Project Breakdown</h2>
          <span
            className={`rounded-full absolute left-0 -bottom-4 h-[5px] bg-black transition-all duration-300 ease-out w-full`}
          />
      </div>
      <div className="mt-20"/>
      <Problem
